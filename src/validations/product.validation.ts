...
export const createProductSchema = Joi.object({
  sku: Joi.string().required().messages({ // Added SKU
  ...
  discountPrice: Joi.number().positive().optional().allow(null).messages({ // Added discountPrice
  ...
  images: Joi.array().items(productImageSchema).optional().min(1).messages({ // Added images validation
    'array.base': 'Images must be an array',
    'array.min': 'At least one image is required if images array is provided',
  }),
  tags: Joi.array().items(tagSchema).optional().messages({ // Added tags validation
     'array.base': 'Tags must be an array of strings',
  }),
  variants: Joi.array().items(productVariantSchema).optional().messages({ // Added variants validation
...
export const updateProductSchema = Joi.object({
  sku: Joi.string().optional().messages({ // Added optional SKU
  ...
  discountPrice: Joi.number().positive().optional().allow(null).messages({ // Added optional discountPrice
    'number.base': 'Discount price must be a number',
    'number.positive': 'Discount price must be a positive number',
  }),
  ...
  images: Joi.array().items(productImageSchema).optional().min(1).messages({ // Added optional images validation
    'array.base': 'Images must be an array',
    'array.min': 'At least one image is required if images array is provided',
  }),
   tags: Joi.array().items(tagSchema).optional().messages({ // Added optional tags validation
     'array.base': 'Tags must be an array of strings',
  }),
  variants: Joi.array().items(productVariantSchema).optional().messages({ // Added optional variants validation
     'array.base': 'Variants must be an array',
  }),
